...
class TestingLinks extends StatefulWidget {
  final String newsapi;
  const TestingLinks({Key? key, required this.newsapi}) : super(key: key);

  @override
  State<TestingLinks> createState() => _TestingLinksState();
}
...
class _TestingLinksState extends State<TestingLinks> {
  // List<dynamic> posts = [];
  // List<dynamic> posts2 = [];
  List posts = [];
